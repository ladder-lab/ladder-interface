...
export const LOCK_LIQUIDITY_ADDRESS = '0x7817131122358f04f387D002185779d7333737a4'

export const LOCK_LIQUIDITY_CONTRACT_ADDRESS = '0x5944b5CAb81F21c31AB777ae53071dA8eDA81bFD'

export const LOCK_LP_TOKEN = new Token(11155111, LOCK_LIQUIDITY_ADDRESS, 18, 'LAD-V1', 'Ladder V1')
