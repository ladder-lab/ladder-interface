      ...
      >
        <Box maxWidth={600} display={'flex'} flexDirection={'column'} justifyContent={'center'}>
          ...
          <Typography fontSize={20} sx={{ color: theme.palette.text.secondary }}>
            The Ladder Airdrop is designed to reward early supporters and active traders. The more you interact with our
            protocol, the higher your rewards will be! Complete the tasks below to receive more Ladder Boxes and
            increase your Luck!
          </Typography>
          <Box
            margin="40px 0"
            ...
            <Box
              ...
              sx={{
                '& #needle': {
                  transition: '.5s',
                  transform: `rotate(${
                    -47 + (((137 + 47) / 300) * airdropData?.myLuck ? Number(airdropData.myLuck) : 150)
                  }deg)`,
